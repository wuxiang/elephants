...
class singleton_pool
{
  public:
    ...
    */
    ...
    static const unsigned requested_size = RequestedSize; //!< The size of each chunk allocated by this pool.
    static const unsigned next_size = NextSize; //!< The number of chunks to allocate on the first allocation.
...
private:
   ...
   static pool_type& get_pool()
   {
      ...
      static pool_type  singleton_handler;
